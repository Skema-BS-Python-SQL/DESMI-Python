...
def get_candidate_name():
  ...
  # Add a positive comment on the name
  print(f"That's a lovely name, {candidate_name}!")
  # Added question about age
  age = input("How old are you? ")
  print(f"Nice, {age} is a great age for this flashcard quiz!")
